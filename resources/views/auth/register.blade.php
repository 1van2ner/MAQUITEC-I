...
<head>
    ...
    <title>Registrarse - MAQUITEC I.S.A.C.</title>
    <style>
        :root { 
            --amarillo: #FFD700; 
        ...
        * { box-sizing: border-box; }
        ...
        .auth-card {
            ...
            width: 100%;
            max-width: 760px; /* Ancho amplio para diseño de 2 columnas */
            padding: 40px 48px;
            border-radius: 20px;
        ...
        /* Estructura de Formulario en Grid de 2 columnas */
        .form-grid {
            display: grid;
        ...
        /* Botón de acción principal sofisticado */
        ...
        @media (max-width: 680px) {
            ...
            .btn-submit-container, .auth-footer-links { grid-column: span 1; }
            ...
            <form action="{{ url('/register') }}" method="POST">
                ...
                <div class="form-grid">
                    ...
                    <div class="auth-footer-links">
                        ¿Ya posees una cuenta? <a href="{{ url('/login') }}">Ingresar aquí</a>
                    </div>
