...
<body>
    ...
    <section class="hero">
        <div>
            ...
            <p>Asesoría, instalación y mantenimiento de equipos industriales para asegurar operaciones seguras, productivas y confiables.</p>
        </div>
    </section>
    ...
    <footer id="contacto">  
        <div class="footer-grid">
            <div>
                ...
                <p>Teléfono: 963727185 / 987654321</p>
                <p>Email: info@maquitec.com</p>
            </div>
            <div>
